...
@interface TaskTableViewController ()<ADAppointmentTableViewCellDelegate>
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *settingsButton = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"subject"] style:UIBarButtonItemStylePlain target:self action:@selector(settingsButtonPressed)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TaskDetailViewController *detailVC = [self.storyboard instantiateViewControllerWithIdentifier:@"ADAppointmentDetailViewController"];
...
- (void)addAppointmentButtonPressed {
    TaskDetailViewController *AddAppointmentVC = [self.storyboard instantiateViewControllerWithIdentifier:@"ADAppointmentDetailViewController"];
...
- (void)settingsButtonPressed {
    SubjectViewController *settingsVC = [self.storyboard instantiateViewControllerWithIdentifier:@"ADSettingsViewController"];
